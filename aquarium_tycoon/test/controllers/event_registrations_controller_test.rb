...
class EventRegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_registration" do
    assert_difference('EventRegistration.count') do
      post event_registrations_url, params: { event_registration: { event: @event_registration.event, guest_count;integer: @event_registration.guest_count;integer, member: @event_registration.member, registration_code: @event_registration.registration_code, time: @event_registration.time } }
    end
  ...
  test "should update event_registration" do
    patch event_registration_url(@event_registration), params: { event_registration: { event: @event_registration.event, guest_count;integer: @event_registration.guest_count;integer, member: @event_registration.member, registration_code: @event_registration.registration_code, time: @event_registration.time } }
